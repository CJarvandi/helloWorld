...
with app.app_context():
    ...
    users = [
        {'username': 'cjarvand', 'email': 'cjarvand@umd.edu', 'first_name': 'Cameron', 'last_name': 'Jarvandi',
         'password': generate_password_hash('fakepw', method='pbkdf2:sha256'), 'role': 'STUDENT'},
